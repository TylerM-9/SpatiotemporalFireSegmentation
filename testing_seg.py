...
def main(frame, epochs):
    ...
    for i in range(1,18):
        ...
        db_test = db.FIREDataset(transform=composed_transforms,num_frame=num_frame)
    ...
    print("Weights in")
    db_test = db.FIREDataset(inputRes=(400,710),transform=composed_transforms,num_frame=num_frame)
    testloader = DataLoader(db_test, batch_size=1, shuffle=True)
