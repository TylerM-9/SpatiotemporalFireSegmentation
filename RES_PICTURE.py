"""
Testing script for ResUNet with vertical 400x710 format
Evaluates all thresholds, selects best, saves single target example
"""
...
def main(epochs, test_thresholds=None, target_example_index=141, selection_metric="mean_iou_classes"):
    """
    Main testing function for ResUNet model
    ...
    with torch.no_grad():
        for ii, sample_batched in enumerate(testloader):
            ...
            save_example_image_vertical_fixed(
                images, gt_sample, seg_pred, ii, examples_dir, best_t,
                out_w=400, out_h=710,
    ...
    with open(summary_path, "w") as f:
        f.write("ResUNet Best Threshold Summary\n")
        f.write("=" * 50 + "\n")
