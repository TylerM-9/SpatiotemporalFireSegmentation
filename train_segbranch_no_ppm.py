...
from network.joint_pred_seg import SegBranch, SegDecoder,SegEncoder, SimpleAttentionBlock, SegDecoderNoPPM
...
lr_decay = 0.9
sidWeight = 0.5
modelName = 'Seg_Branch_NoAttention'
...
def main():
    ...
    plt.ylabel("Loss")
    plt.title("No PPM Loss Pre-Training")
    plt.legend()
    plt.grid(True)

    # Save the plot as a PNG file
    plt.savefig("No_PPM_Loss_PreTraining.png", dpi=300, bbox_inches='tight')
